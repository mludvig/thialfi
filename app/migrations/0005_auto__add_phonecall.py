...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_phonecall', (
            ...
            ('call_id', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('text_to_say', self.gf('django.db.models.fields.CharField')(max_length=500, null=True)),
            ('numbers_gathered', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('duration', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('dt_queued', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
