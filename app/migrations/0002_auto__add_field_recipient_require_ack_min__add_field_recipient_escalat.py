...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipient.require_ack_min'
        db.add_column('app_recipient', 'require_ack_min',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Recipient.escalation_group'
        db.add_column('app_recipient', 'escalation_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='escalation_group', null=True, to=orm['app.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipient.require_ack_min'
        db.delete_column('app_recipient', 'require_ack_min')

        # Deleting field 'Recipient.escalation_group'
        db.delete_column('app_recipient', 'escalation_group_id')
