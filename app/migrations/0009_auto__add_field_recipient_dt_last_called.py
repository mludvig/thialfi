...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipient.dt_last_called'
        db.add_column('app_recipient', 'dt_last_called',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipient.dt_last_called'
        db.delete_column('app_recipient', 'dt_last_called')
    ...
    models = {
        ...
        'app.recipient': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'dt_last_called': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
